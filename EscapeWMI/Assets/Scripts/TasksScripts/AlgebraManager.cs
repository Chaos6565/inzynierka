...
public class AlgebraManager : MonoBehaviour
{
    ...
    public void SubmitClick()
    {
        ...
        if (((answer1.isOn && answer2.isOn) && (!answer3.isOn && !answer4.isOn && !answer5.isOn) ||
            (answer1.isOn && answer4.isOn) && (!answer2.isOn && !answer3.isOn && !answer5.isOn) ||
            (answer2.isOn && answer4.isOn) && (!answer1.isOn && !answer3.isOn && !answer5.isOn))) points = 2;

        if ((answer1.isOn && (!answer2.isOn && !answer3.isOn && !answer4.isOn && !answer5.isOn)) ||
            (answer2.isOn && (!answer1.isOn && !answer3.isOn && !answer4.isOn && !answer5.isOn)) ||
            (answer4.isOn && (!answer1.isOn && !answer2.isOn && !answer3.isOn && !answer5.isOn))) points = 1;
